                    ...
                    <form method="post">
                        <figure class="image_area position-relative rounded-circle font-weight-bold overflow-hidden mx-2"
                            ...
                            <div class="overlay d-flex justify-content-center align-items-center">
                                <span class="text-center text-light m-0 p-2" style="font-size: 0.875rem;"
                                    data-toggle="modal" data-target="#uploadimageModal">Klik untuk mengubah foto
                                    profil</span>
                            </div>
                        </figure>
                    </form>
        ...
        <div class="col-lg-8">
            <div class="card shadow  mb-3">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <a class="btn btn-primary" href="{{ route('member.profiles.edit', $user->id) }}">Edit</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        $(document).ready(function() {
            ...
            $('.crop_image').click(function(event) {
                $image_crop.croppie('result', {
                    ...
                    $.ajax({
                        url: "{{ route('member.profiles.updateAvatar') }}",
                        type: "POST",
                        dataType: "json",
                        data: {
                            "avatar": response,
