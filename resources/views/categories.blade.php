...
@section('content')
    ...
    <main role="main">
        <div id="collection" class="container mt-5">
            <div class="mb-5">
                <h3 class="mb-2 text-black">Kategori {{ $category_name ?? '' }}</h3>
            ...
            <div class="mb-5">
                <form class="bg-light p-2 rounded" action="">
                    ...
                    <a href="{{ route('detailCategory', $category_slug ?? '') }}" class="btn btn-secondary">
            ...
            @elseif(isset($request))
                <div class="alert alert-secondary" role="alert">
                    <h4>Mohon maaf, tidak ada buku seperti yang Anda cari.</h4>
                </div>
            @else
                <div class="alert alert-secondary" role="alert">
                    <h4>Mohon maaf, daftar buku belum ada.</h4>
                </div>
            @endif
        </div>
    </main>
