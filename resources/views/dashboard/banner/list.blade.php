...
<div class="card shadow mb-4">
  <div class="card-body">
    <div class="table-responsive">
      <table class="table table-bordered" id="dataBanner" width="100%" cellspacing="0">
        <thead>
          <tr>
            <th scope="col" style="width: 20%">Background</th>
            <th scope="col" style="width: 30%">Judul Banner</th>
  ...
  $.ajax({
    ...
    success: function (data) { 
      setTimeout(function () {
        ...
        var oTable = $('#dataBanner').dataTable();
        oTable.fnDraw(false);
      });
      iziToast.warning({
